...
Please read these guidelines before contributing to Grappachu.Core:
...
If you have questions about how to use Grappachu.Core, please read the
[Grappachu.Core documentation][documentation].
...
- Check that new and updated code follows Grappachu.Core's existing code formatting and naming standard
- Run Grappachu.Core's unit tests to ensure no existing functionality has been affected
...
By contributing your code to Grappachu.Core you grant Davide Prenassi a non-exclusive, irrevocable, worldwide,
...
[github]: https://github.com/grappachu/core
